...
class CategoriasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categoria" do
    assert_difference('Categoria.count') do
      post categorias_url, params: { categoria: { descripcion: @categoria.descripcion, estado: @categoria.estado } }
    end
  ...
  test "should update categoria" do
    patch categoria_url(@categoria), params: { categoria: { descripcion: @categoria.descripcion, estado: @categoria.estado } }
