...
class CatalogosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catalogo" do
    assert_difference('Catalogo.count') do
      post catalogos_url, params: { catalogo: { descripcion: @catalogo.descripcion, titulo: @catalogo.titulo } }
    end
  ...
  test "should update catalogo" do
    patch catalogo_url(@catalogo), params: { catalogo: { descripcion: @catalogo.descripcion, titulo: @catalogo.titulo } }
